void sl_replay_production_coin_pElec_hProt (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  */
  ...
  // Define cuts file
  analyzer->SetCutFile("DEF-files/COIN/PRODUCTION/CUTS/sl_coin_production_cuts.def");  // optional
